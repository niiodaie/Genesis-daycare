  ...
  return (
    <section className="relative isolate">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        >
          {/* Prefer local asset; keep remote as safe fallback if needed */}
          <source src="/videos/hero.mp4" type="video/mp4" />
          {/* <source src="https://genesisroyaltydaycare.com/wp-content/uploads/2025/02/infant-video-1.mp4" type="video/mp4" /> */}
        </video>
      ...
      <div className="container-p min-h-[72vh] md:min-h-[80vh] flex items-center">
        <div className="max-w-3xl text-white drop-shadow-md">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/book-tour" className="btn btn-primary">
              Book a tour
            </Link>
